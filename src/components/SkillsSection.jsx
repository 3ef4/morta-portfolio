...
const skills = [
  // IT & Support
  { name: "IT Support & Help Desk", level: 95, category: "it" },
  { name: "System Maintenance", level: 95, category: "it" },
  { name: "Hardware & Software Troubleshooting", level: 90, category: "it" },
  { name: "Digital Transformation", level: 80, category: "it" },
  { name: "ERP Systems", level: 70, category: "it" },
