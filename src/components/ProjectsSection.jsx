...
const projects = [
  ...
  },
  {
    ...
    description:
      "تطبيق موبايل لإدارة الميزانية الشخصية مبني بـ Flutter، يساعد المستخدم على تتبع الواردات والمصروفات، إدارة الفواتير والديون والمدخرات، وتطبيق قاعدة 80/20 لتوزيع الميزانية بذكاء.",
