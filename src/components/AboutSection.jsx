            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  <h4 className="font-semibold text-lg"> IT Support & Help Desk</h4>
                  <p className="text-muted-foreground">
                    Troubleshooting hardware and software issues, and
                    supporting IT infrastructure end-to-end.
                  </p>
                </div>
              </div>
            </div>
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Working with Arduino and embedded systems to build and
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Implementing technology solutions and ERP systems to
